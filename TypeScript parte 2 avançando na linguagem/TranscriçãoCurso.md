# Curso Alura TypeScript parte 2 avançando na linguagem
...
Você pode ir acompanhando o passo a passo do desenvolvimento do nosso projeto e, caso deseje, você pode [baixar o projeto do curso](https://github.com/alura-cursos/typescript-curso-2/archive/67b1b1ee4847476c1be8c82880e206eb0f62a2f9.zip).
...
Como você pode fazer uma implementação em TypeScript que atenda à nossa necessidade de calcular a diferença em dias entre duas datas fornecidas pelo usuário?
...
### Aula 3 - Conhecendo enumerations - Vídeo 6
...
### Aula 4 - Utilizando parâmetros opcionais - Vídeo 4
...
### Aula 4 - Sobre parâmetros opcionais - Exercício
...
> O código compila, pois o parâmetro opcional é o último parâmetro.

Alternativa correta  
function(a: number, b?:number, c?:number): void { }

> O código compila, pois os parâmetros opcionais são os últimos parâmetros.

### Aula 4 - Revisão - Vídeo 5
...
### Aula 5 - Removendo comentários do código - Vídeo 1
...
### Aula 5 - Mudança no tsconfig.json

Desafio proposto pela Luri, a IA da Alura.

Você tentou remover comentários de seus arquivos ts durante o processo de compilação para JavaScript. No entanto, os comentários ainda continuaram presentes nos arquivos js. A configuração feita no "tsconfig.json" está representada abaixo:
...
> Com base no código acima, qual seria o motivo dos comentários ainda aparecerem nos arquivos JavaScript?

Resposta:  
É que "removeComments": false, está como FALSE e deveria ser TRUE

### Aula 5 - A configuração strictNullChecks - Vídeo 2
...
### Aula 5 - Revisando o strictNullChecks - Exercício

Você e sua equipe estão trabalhando em um projeto TypeScript e decidem ativar a opção strictNullChecks no arquivo "tsconfig.json" para resolver problemas com valores nulos e indefinidos.

Qual o efeito de ativar o strickNullChecks em seu projeto?

Alternativa correta!  
strictNullChecks impede que variáveis sejam atribuídas com null ou undefined a menos que sejam tipadas para aceitar esses valores.

> Exatamente! Com strictNullChecks ativado, o TypeScript exige que variáveis sejam explicitamente tipadas para aceitar null ou undefined, caso contrário, um erro de compilação ocorrerá.

### Aula 5 - Suprimindo a checagem onde faz sentido - Vídeo 3
...
### Aula 5 - Tratando null em nosso código - Vídeo 4
...
### Aula 5 - Últimos ajustes - Vídeo 5
...
Você pode [baixar o projeto](https://github.com/alura-cursos/typescript-curso-2/archive/30b4b7cd0d845e19cbc50a784c1b67a602d6ed36.zip) final ou acessar os [arquivos no GitHub](https://github.com/alura-cursos/typescript-curso-2/).
